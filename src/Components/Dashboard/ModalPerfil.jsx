...
function ModalPerfil({ closeModal, modalIsOpen }) {

    const { handlechange, handlesubmit, open } = useTienda();
    const titulo = "Cambiar Foto de Perfil";
    // open && closeModal();

    return (
        <Modal closeModal={closeModal} modalIsOpen={modalIsOpen} handleSubmit={handlesubmit} titulo={titulo}>
